...
exports.defaultLinkCreator = function (session, wsEndpoint) {
    ...
    var finalSubscriptionsEndpoint = wsEndpoint || subscriptionEndpoint;
    var subscriptionClient = new subscriptions_transport_ws_1.SubscriptionClient(finalSubscriptionsEndpoint, {
        timeout: 20000,
        lazy: true,
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 6:
                ...
                _a = linkCreator(lol), link = _a.link, subscriptionClient = _a.subscriptionClient;
