...
var GraphDocs = /** @class */function (_super) {
    ...
    GraphDocs.prototype.render = function () {
        ...
        return React.createElement(
            ...
            React.createElement(DocsResizer, { onMouseDown: this.handleDocsResizeStart }),
            React.createElement(DocsGradient, null),
            React.createElement(
                DocsExplorer,
                { onKeyDown: this.handleKeyDown, onMouseMove: this.handleMouseMove, tabIndex: 0, ref: this.setDocExplorerRef },
                React.createElement(
...
var DocsExplorer = styled_1.styled.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  background: white;\n  display: flex;\n  position: relative;\n  height: 100%;\n  letter-spacing: 0.3px;\n  outline: none;\n  box-shadow: -1px 1px 6px 0 rgba(0, 0, 0, 0.3);\n\n  &::before {\n    top: 0;\n    bottom: 0;\n    background: ", ";\n    position: absolute;\n    z-index: 3;\n    left: 0px;\n    content: '';\n    width: 6px;\n  }\n"], ["\n  background: white;\n  display: flex;\n  position: relative;\n  height: 100%;\n  letter-spacing: 0.3px;\n  outline: none;\n  box-shadow: -1px 1px 6px 0 rgba(0, 0, 0, 0.3);\n\n  &::before {\n    top: 0;\n    bottom: 0;\n    background: ", ";\n    position: absolute;\n    z-index: 3;\n    left: 0px;\n    content: '';\n    width: 6px;\n  }\n"])), function (props) {
    return props.theme.colours.green;
});
