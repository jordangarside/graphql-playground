...
var ReloadIcon = function (props) { return (<Positioner onClick={props.onReloadSchema} title="Reload Schema">
    <Svg viewBox="0 0 20 20">
      <Circle cx="9.5" cy="10" r="6" strokeWidth="1.5" fill="none" strokeLinecap="round" isReloadingSchema={props.isReloadingSchema}/>
...
// it makes the element animated with these keyframes to trigger
// again the animation
var reloadAction = function (props) { return index_1.keyframes(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n0% {\n  transform: rotate(", "deg);\n}\n\n100% {\n  transform: rotate(", "deg);\n}"], ["\n0% {\n  transform: rotate(", "deg);\n}\n\n100% {\n  transform: rotate(", "deg);\n}"])), props.isReloadingSchema ? 0 : 360, props.isReloadingSchema ? 360 : 720); };
